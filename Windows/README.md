# LockCode para Windows 0.4.7

Proyecto independiente para Windows 10 2004 o posterior. No usa archivos ni configuración de la edición macOS.

Versión publicada: **0.4.7**. Uso gratuito sujeto a la [Política de uso general](../USAGE_POLICY.md) y a las condiciones mostradas por el instalador.
...
El instalador moderno se crea en `Installer\output\LockCode-Windows-0.4.7-Setup.exe`. Incluye:
...
1. Ejecuta `LockCode-Windows-0.4.7-Setup.exe`.
