...
- Fuentes 0.4.7 comprobadas con Swift 6.3.3, concurrencia completa y warnings como errores: type-check correcto; la suite XCTest no puede ejecutarse sin Xcode completo.
...
- Bundle universal 0.4.7 para Intel y Apple Silicon enlazado, firmado con `LockCode Local Signing`, verificado con `codesign` y empaquetado en `macOS/Installer/output/LockCode-macOS-0.4.7.zip` (SHA-256 `bd2f7180109c5db27d21ed8491b2892a5c30dbe7852e9923f23c744865fbd932`).
