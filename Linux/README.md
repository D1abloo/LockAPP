...
Versión publicada: **0.4.7**. LockCode es gratuito, no requiere donación y se distribuye conforme a la [Política de uso](../USAGE_POLICY.md).
...
sudo apt install ./installer/output/lockcode-linux_0.4.7_all.deb
```
